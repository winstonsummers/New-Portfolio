	...
	render(){
		return(
			<div id="about">
				...
				<p><i>I am</i> a SDE I excited to grow on existing skill sets and bring value to the team and company. Excelling at researching problems to find solutions, not giving up until the job is done. </p>
